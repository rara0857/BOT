...
def load_translate():
    ...
    en_us["ticketplus_phone"] = 'TicketPlus Phone'
    ...
    zh_tw["ticketplus_phone"] = 'TicketPlus 電話'
    zh_tw["password"] = '密碼'
    ...
    zh_cn["ticketplus_phone"] = 'TicketPlus 电话'
    zh_cn["password"] = '密码'
    ...
    ja_jp["ticketplus_phone"] = 'TicketPlus 電話'
...
def btn_save_act(language_code, slience_mode=False):
    ...
    if is_all_data_correct:
        ...
        config_dict["advanced"]["password"] = txt_password.get().strip()
...
def PreferenctTab(root, config_dict, language_code, UI_PADDING_X):
    ...
    combo_homepage['values']= ("https://kktix.com","https://tixcraft.com","https://ticketplus.com.tw","https://www.indievox.com/","https://www.famiticket.com.tw","http://www.urbtix.hk/","https://www.cityline.com/","https://ticket.ibon.com.tw/")
...
def AdvancedTab(root, config_dict, language_code, UI_PADDING_X):
    ...
    if 'advanced' in config_dict:
        ...
        if 'password' in config_dict["advanced"]:
            password = config_dict["advanced"]["password"].strip()
        if 'ticketplus_account' in config_dict["advanced"]:
            ticketplus_account = config_dict["advanced"]["ticketplus_account"].strip()
    ...
    print("ticketplus_account", ticketplus_account)
    ...
    lbl_ticketplus_account = Label(frame_group_header, text=translate[language_code]['ticketplus_phone'])
    lbl_ticketplus_account.grid(column=0, row=group_row_count, sticky = E)

    global txt_ticketplus_account
    txt_ticketplus_account_value = StringVar(frame_group_header, value=ticketplus_account)
    txt_ticketplus_account = Entry(frame_group_header, width=20, textvariable = txt_ticketplus_account_value)
    ...
    lbl_password.grid(column=0, row=group_row_count, sticky = E)

    global txt_password
    txt_password_value = StringVar(frame_group_header, value=password)
    txt_password = Entry(frame_group_header, width=20, textvariable = txt_password_value, show="*")
    txt_password.grid(column=1, row=group_row_count, sticky = W)
